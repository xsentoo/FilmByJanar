...
const EVENTS_DATA: EventData[] = [
  ...
  },
  {
    ...
    description: 'COLLABORATING WITH CREATIVE MINDS AND PERFORMERS TO TRANSLATE MUSIC, PASSION, AND VISION INTO STUNNING CINEMATIC PORTRAITS. CAPTURING THE RAW EMOTION, STAGE PRESENCE, AND UNIQUE EXPRESSION OF ARTISTS IN THEIR ELEMENT.',
    photos: [
